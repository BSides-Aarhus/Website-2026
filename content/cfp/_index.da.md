...
- **AI & nye teknologier** — generativ AI, LLM'er, kryptografi
- **Engineering & kode** — sikker kodning, reverse engineering, malwareanalyse
- **Infrastruktur** — cloud sikkerhed, virtualisering, mobilsikkerhed
- **Netværk & hardware** — trådløs, telekommunikation, embedded enheder
- **Menneskelige elementer** — social engineering, privatliv, GRC
- **Live demonstrationer** — værktøjsdemoer, proof-of-concept gennemgange

## Foredragsformat

- **Varighed:** 45 minutter (40 minutters præsentation + 5 minutters Q&A)
- **Spor:** To parallelle spor
